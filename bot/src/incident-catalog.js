...
const DEFINITIONS = Object.freeze({
  ...
  [INCIDENT.DATABASE_MIGRATION_FAILED]: {
  ...
  [INCIDENT.BACKUP_PROTECTION_LOST]: {
  ...
  [INCIDENT.QUEST_API_SCHEMA_INCOMPATIBLE]: {
  ...
  [INCIDENT.QUEST_API_TRANSPORT_OUTAGE]: {
  ...
  [INCIDENT.RUNNER_RESTORE_SYSTEM_FAILED]: {
...
export function getIncidentDefinition(code) {
  ...
  if (!definition) throw new TypeError(`Unknown incident code: ${code}`);
  return definition;
}
